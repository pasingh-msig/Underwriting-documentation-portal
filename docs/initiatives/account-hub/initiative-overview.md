# Account Hub - Initiative Overview

## Purpose
Account Hub supports account and party data access within the underwriting portfolio.

## Business Objective
Establish a documented baseline for Account Hub so business, technical, support, and audit stakeholders can work from the same source of truth.

## Strategic Alignment
Account Hub contributes to underwriting modernization by improving standardization, visibility, and integration readiness across the portfolio.
...
|---|---|---|---|
| Account Hub Service | Application / Service | Primary documented component for Account Hub | <Owner> |
...
## Dependencies
Primary dependencies include master data source, UWWB.
